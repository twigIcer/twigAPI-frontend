...
/** testCount GET /api/userInterfaceInfo/testCount */
export async function testCountUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponsestring>('/api/userInterfaceInfo/testCount', {
    method: 'GET',
    ...(options || {}),
  });
}
